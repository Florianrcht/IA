...
p.ChangeDutyCycle(3)     # On change le cycle avec un Duty Cycle à 3% (0 degré / position initiale)
sleep(1)                 # Attente
p.ChangeDutyCycle(12)    # On change le cycle avec un Duty Cycle à 12% (180 degré / position opposée à celle initiale)
sleep(1)                 # Attente
